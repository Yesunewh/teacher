...
<div class="page-body">
    ...
    <div class="container-xl ">
        <div class="row ">
            <div class="col-6  col-lg-5 lg:pr-14">
                <form class="row" id="openai_generator_form" onsubmit="return sendOpenaiGeneratorForm();">
                    ...
                    <div class="mb-3 col-xs-12 col-md-12">
                        ...
                        <input type="text" class="form-control" id="maximum_length" name="title" id="title"
                    ...
                    <div class="mb-3 col-xs-12 col-md-12">
                        ...
                        <select type="text" class="form-select" name="Subject" id="Subject" required>
                            ...
                            <option value="Mathematics and Sciences">Mathematics and Sciences</option>
                            <option value="Arts and Humanities">Arts and Humanities</option>
                            <option value="Physical Education and Health">Physical Education and Health
                            </option>
                            <option value="Technical and Life Skills">Technical and Life Skills</option>
...
<script>
    const stream_type = '{!!$settings_two->openai_default_stream_server!!}';
        ...
        function sendOpenaiGeneratorForm(ev){
            ...
            formData.append('openai_id', '4');
          
            formData.append('maximum_length', '200');
            formData.append('number_of_results', '1');
            ...
            $.ajax({
                ...
                url: "/dashboard/teacher/generate/unitplanner",
                data: formData,
                contentType: false,
                processData: false,
