        ...
        <div class="row g-2 items-center justify-between max-md:flex-col max-md:items-start max-md:gap-4">
            <div class="col col-xs-12">
                ...
                <div class="page-pretitle">
                    {{__('
                    Enter the following information to get started with this tool')}}
                </div>
    ...
    <div class="container-xl ">
        <div class="row ">
            <div class="col-6">
                ...
                <div class="mb-3 col-xs-12 col-md-12">
                    <label class="form-label">{{__('Course Description*')}}</label>
                    <textarea name="description*" class="form-control" id=""
                        placeholder="What is this course about?"></textarea>

                </div>
                <div class="mb-3 col-xs-12 col-md-12">
                    <label class="form-label">{{__('Course Objectives*')}}</label>
                    <textarea name="description*" class="form-control" id=""
                        placeholder="What are   course objectives?"></textarea>

                </div>

                <div class="mb-3 col-xs-12 col-md-12">
                    <label class="form-label">{{__('Required Materials*')}}</label>
                    <textarea name="description*" class="form-control" id=""
                        placeholder="List of materials needed for this course .."></textarea>
