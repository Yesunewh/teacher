				...
				<div id="table-default" class="card-table table-responsive">
					<table class="table">
						...
						<tr>
                            ...
                            <th><button class="table-sort" data-sort="sort-name">{{__('Subject Name')}}</button></th>
                            <th><button class="table-sort" data-sort="sort-group">{{__('Field Of Study')}}</button></th>
                        ...
                        @if(env('APP_STATUS') != 'Demo')
                            @foreach($subject as $entry)
                                <tr>
                                    ...
                                    <td class="sort-remaining-words">{{$entry->subject->name}}</td>

                                    <td class="sort-group">{{$entry->field_of_study}} </td>
